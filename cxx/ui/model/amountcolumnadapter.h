...
public:
    ...
    AmountColumnAdapter(QString title, std::function<Value(const T*)> getter, FormatterType formatter, bool editable = false, ValidatorFactory *factory = nullptr)
        : NumberColumnAdapter<T, Value>{title, getter, editable, factory}, formatter{formatter} {}
